# Implementación del Sistema en la Hoja 2_QUINC

## Pasos para implementar el sistema en 2_QUINC:

### 1. Copiar el código del evento Worksheet_Change

Debes copiar el código del evento `Worksheet_Change` que está en `worksheet.md` y pegarlo en la hoja `2_QUINC`. Para hacer esto:

1. Abre el VBA Editor (Alt + F11)
2. En el Project Explorer, busca la hoja `2_QUINC`
3. Haz doble clic en la hoja `2_QUINC`
4. En el código de la hoja, agrega el evento `Worksheet_Change`

### 2. Código a copiar en 2_QUINC:
...
### 3. Agregar la función EsHojaValida en un módulo

En el VBA Editor, crea un nuevo módulo (Insert > Module) y agrega esta función:
...
### 4. Verificar que las funciones de registro estén disponibles

Asegúrate de que todas las funciones de registro (RegistrarTurnoL, BorrarTurnoL, etc.) estén disponibles en el proyecto. Estas funciones deben estar en el archivo `registrarTurnoLyBorrar.md`.

### 5. Probar el sistema

1. Activa la macro con `ActivarMacro()`
